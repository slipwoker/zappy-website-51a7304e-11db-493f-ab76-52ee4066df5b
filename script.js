document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // If valid — show success (replace with actual submission logic as needed)
      showFormSuccess();
      contactForm.reset();
    });
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יסודות היין – SADAFRONIA משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '51a7304e-11db-493f-ab76-52ee4066df5b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '51a7304e-11db-493f-ab76-52ee4066df5b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '51a7304e-11db-493f-ab76-52ee4066df5b';
